...
Author.create!(
  name: "Adad Lovelace", email: "adad@the-history-of-programming.com"
)

Post.create!(
  title: "How to Science",
  content: "arcu lorem hendrerit purus, ac sagittis ipsum nisl nec erat. Morbi porta sollicitudin leo, eu cursus libero posuere ac. Sed ac ultricies ante. Donec nec nulla ipsum. Nunc eleifend, ligula",
  category: "Fiction"
)
